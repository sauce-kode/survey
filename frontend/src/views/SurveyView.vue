            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center">
                        ...
                        <span v-else class="flex items-center justify-center h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-[80%] text-gray-300">
                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="status" type="checkbox" v-model="model.status" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
